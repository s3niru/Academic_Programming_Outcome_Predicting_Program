...
def save_data_file(list):#Function to save progression data to "progression_data.txt" file
    with open("progression_data.txt","a") as file:#Open the file "progression_data.txt" file
        for x in list:
            file.write(x)#Appending each element in every list into "progression_data.txt" file
            file.write("\n")

def read_data_file():#Function to read and print the data of "progression_data.txt" file
    with open("progression_data.txt","r") as file:
        print(file.read())#Display data in the "progression_data.txt" file
...
while choice == 'y':
    ...
    while True:
        ...
        if choice == 'y':
            ...
            save_data_file(progress_list)#save elemets of progress_list into "progression_dat.txt" file
            save_data_file(trailer_list)#save elemets of trailer_list into "progression_dat.txt" file
            save_data_file(retriever_list)#save elemets of retriver_list into "progression_dat.txt" file
            save_data_file(exclude_list)#save elemets of exclude_list into "progression_dat.txt" file

            read_data_file()#Display the contetnts of the "ptogression_data.txt" file
